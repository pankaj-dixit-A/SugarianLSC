...
const Navbar = () => {
  ...
  const navbarRef = useRef(null); // Ref to the navbar for detecting outside interaction

  // Handle mouse enter on menu items
  const handleMouseEnter = (menuName) => {
    setActiveMenu(menuName);
    if (!clickedMenu) {
      // Prevent resetting submenus if a menu is clicked
      setActiveSubMenu("");
    }
  };
  ...
  const handleSubMenuItemClick = (subMenuName, event) => {
    event.stopPropagation(); // Prevent the click from affecting higher menu levels
    setActiveSubMenu(subMenuName); // Set the submenu as active, ensuring it stays open or becomes active
  };
    ...
    <div ref={navbarRef} className="navbar" onMouseLeave={handleMouseLeave}>
          ...
          <div className="submenu">
            ...
            >
              ...
              {activeSubMenu === "Other_Master" && (
                <div className="submenu1">
                  <div className="submenu-item1">
                    <a href="/syetem-master">System Master</a>
                  </div>
                  <div className="submenu-item1">
      ...
      >
        ...
        {activeMenu === "inward" && (
          <div className="submenu">
            <div className="submenu-item">
              <a href="/purchase-bill">Purchase Bill</a>
            </div>
            <div className="submenu-item">
      ...
      >
        ...
        {activeMenu === "business-related" && (
          <div className="submenu">
            <div className="submenu-item">
              <a href="/tender-purchase">Tender Purchase(Sauda Booking)</a>
            </div>
            <div className="submenu-item">
